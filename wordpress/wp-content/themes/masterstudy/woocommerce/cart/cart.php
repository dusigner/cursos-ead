...
<div class="table-responsive">
	<table class="table shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				<th class="product-remove"><?php _e( 'Delete', 'masterstudy'); ?></th>
				<th class="product-name"><?php _e( 'Product name', 'masterstudy'); ?></th>
				<th class="product-price"><?php _e( 'Price', 'masterstudy'); ?></th>
				<th class="product-quantity"><?php _e( 'Quantity', 'masterstudy'); ?></th>
				<th class="product-subtotal"><?php _e( 'Total', 'masterstudy'); ?></th>
			</tr>
		</thead>
		<tbody>
